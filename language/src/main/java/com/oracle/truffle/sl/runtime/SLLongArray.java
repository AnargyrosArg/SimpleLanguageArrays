...
public final class SLLongArray implements TruffleObject{
        ...
        switch(token) {
            case "BIG_ZERO_ARRAY":
                for(int i=0; i< n_iter; i++){
                    this.values.add(Long.valueOf(0));
                }
                break;

            case "BIG_ONES_ARRAY":
                for(int i=0; i< n_iter; i++){
                    this.values.add(Long.valueOf(1));
                }
                break;
    ...
    public SLLongArray(ArrayList<Long> values) {
        this.values = values;
    }
